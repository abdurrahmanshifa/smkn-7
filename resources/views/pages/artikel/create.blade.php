			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
                        ...
                        <form class="form-horizontal" action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-7">
                                   <input type="text" class="form-control" id="exampleTextInput1" name="judul" required placeholder="Judul Artikel..." value="{{ old('judul') }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-9">
                                   <textarea class="form-control" name="isi_artikel" id="isi-artikel" placeholder="Isi Artikel...">{{ old('isi_artikel') }}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
