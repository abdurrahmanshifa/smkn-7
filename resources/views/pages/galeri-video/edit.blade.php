			...
			<div class="col-md-12">
				<div class="widget">
                    <header class="widget-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Edit Galeri Video</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('galeri-video.index') }}" class="btn btn-primary pull-right">
					...
					<div class="widget-body">
                        ...
                        <form class="form-horizontal" action="{{ route('galeri-video.update',$id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                               <label for="textarea1" class="col-sm-2 control-label">Link Youtube :<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="exampleTextInput1" name="link" required placeholder="https://youtube.com/watch?v=AAAAAAAAA" value="{{ $get->link }}">
                                    <div>
                                        {!! $get->galeri_video !!}
                                    </div>
                                </div>
