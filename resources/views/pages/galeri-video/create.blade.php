			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
                        ...
                        <form class="form-horizontal" action="{{ route('galeri-video.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                               <label for="textarea1" class="col-sm-2 control-label">Link Youtube :<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="exampleTextInput1" name="link" required placeholder="https://youtube.com/watch?v=AAAAAAAAA" value="{{ old('link') }}">
                                </div>
                            </div>
                            <div class="form-group">
