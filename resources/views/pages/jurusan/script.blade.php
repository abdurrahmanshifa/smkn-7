...
<script>
    ...
    $("[name=form_input]").on('submit', function(e) {
        ...
        if(save_method == 'add'){
            var url = '{{route("manajemen.jurusan.simpan")}}';
        }else{
            var url = '{{route("manajemen.jurusan.ubah")}}';
        }
    ...
    function ubah(id)
    {
        ...
        $.ajax({
            url : "{{url('manajemen/jurusan/data/')}}"+"/"+id,
            type: "GET",
            dataType: "JSON",
    ...
    function hapus(id){
        Swal.fire({
               ...
               if (result.value) {
                    $.ajax({
                        url : "{{url('manajemen/jurusan/hapus/')}}"+"/"+id,
                        type: "POST",
                        data : {
                            '_method'   : 'delete',
                            '_token'    : '{{ csrf_token() }}',
