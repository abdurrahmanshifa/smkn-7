			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
                        ...
                        <form class="form-horizontal" action="{{ route('jurusan.update',$id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-7">
                                   <input type="text" class="form-control" id="exampleTextInput1" name="judul" required placeholder="Judul jurusan..." value="{{ $get->judul }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="col-md-6" id="img-preview">
                                            <img src="{{ url('show-image/jurusan/'.$get->cover) }}" class="img-thumbnail">
                                        </div>
                                   </div>
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-9">
                                   <textarea class="form-control" name="isi_artikel" id="isi-artikel" placeholder="Isi jurusan...">{{ $get->isi_artikel }}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
